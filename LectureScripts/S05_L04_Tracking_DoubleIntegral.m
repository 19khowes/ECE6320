function S05_L04_Tracking_DoubleIntegral()
close all;
...
% Augmented dynamics
Abar = [A zeros(2,2); C zeros(1,2); 0 0 1 0];
Bbar = [B; 0; 0];
Ebar = [E; 0; 0];
...
%% Dynamics function
    function xbardot = stateDynamics(t, xbar, K, rSol, wSol)
        ...
        xi = xbar - [r; 0; 0]; % Get augmented state
        ...
        sig2_dot = xbar(3);
        xdot = A*x + B*u + E*w(1);
        xbardot = [xdot; sig1_dot; sig2_dot];
    end
